...
const ZA_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Meowstic: {otherFormes: ['Meowstic-F', 'Meowstic-M-Mega', 'Meowstic-F-Mega']},
  ...
  Tatsugiri: {otherFormes: ['Tatsugiri-Curly-Mega']},
  ...
  'Ange': {
    types: ['???', '???'],
    bs: {hp: 2, at: 1, df: 1, sa: 1, sd: 1, sp: 1},
    gender: 'N',
    weightkg: 100.0,
...
const zaLegal = [
  'Abomasnow', 'Abomasnow-Mega', 'Abra', 'Absol', 'Absol-Mega', 'Absol-Mega-Z', 'Aegislash', 'Aegislash-Blade', 'Aerodactyl', 'Aerodactyl-Mega',
  'Aggron', 'Aggron-Mega', 'Alakazam', 'Alakazam-Mega', 'Altaria', 'Altaria-Mega', 'Amaura', 'Amoonguss', 'Ampharos', 'Ampharos-Mega', 'Annihilape',
  'Arbok', 'Arctibax', 'Ariados', 'Armarouge', 'Aromatisse', 'Aron', 'Audino', 'Audino-Mega', 'Aurorus', 'Avalugg', 'Avalugg-Hisui', 'Bagon',
  'Banette', 'Banette-Mega', 'Barbaracle', 'Barbaracle-Mega', 'Baxcalibur', 'Baxcalibur-Mega', 'Bayleef', 'Beedrill', 'Beedrill-Mega', 'Beldum',
  'Bellsprout', 'Bergmite', 'Binacle', 'Blastoise', 'Blastoise-Mega', 'Blaziken', 'Blaziken-Mega', 'Braixen', 'Budew', 'Bulbasaur', 'Buneary',
  'Bunnelby', 'Camerupt', 'Camerupt-Mega', 'Capsakid', 'Carbink', 'Carvanha', 'Ceruledge', 'Chandelure', 'Chandelure-Mega', 'Charcadet', 'Charizard',
  'Charizard-Mega-X', 'Charizard-Mega-Y', 'Charmander', 'Charmeleon', 'Chesnaught', 'Chesnaught-Mega', 'Chespin', 'Chikorita', 'Chimecho', 'Chimecho-Mega',
  'Chingling', 'Clauncher', 'Clawitzer', 'Clefable', 'Clefable-Mega', 'Clefairy', 'Cleffa', 'Clobbopus', 'Cobalion', 'Cofagrigus', 'Combusken',
  'Corviknight', 'Corvisquire', 'Crabominable', 'Crabominable-Mega', 'Crabrawler', 'Crobat', 'Croconaw', 'Cryogonal', 'Cubone', 'Cyclizar', 'Dachsbun',
  'Darkrai', 'Darkrai-Mega', 'Dedenne', 'Delibird', 'Delphox', 'Delphox-Mega', 'Diancie', 'Diancie-Mega', 'Diggersby', 'Dondozo', 'Doublade', 'Dragalge',
  'Dragalge-Mega', 'Dragonair', 'Dragonite', 'Dragonite-Mega', 'Drampa', 'Drampa-Mega', 'Dratini', 'Drilbur', 'Eelektrik', 'Eelektross', 'Eelektross-Mega',
  'Eevee', 'Ekans', 'Electrike', 'Emboar', 'Emboar-Mega', 'Emolga', 'Espeon', 'Espurr', 'Excadrill', 'Excadrill-Mega', 'Falinks', 'Falinks-Mega',
  'Farfetch\u2019d', 'Farfetch\u2019d-Galar', 'Feebas', 'Fennekin', 'Feraligatr', 'Feraligatr-Mega', 'Fidough', 'Flaaffy', 'Flabébé', 'Flamigo',
  'Flareon', 'Fletchinder', 'Fletchling', 'Floette', 'Floette-Eternal', 'Floette-Mega', 'Florges', 'Foongus', 'Frigibax', 'Froakie', 'Frogadier',
  'Froslass', 'Froslass-Mega', 'Furfrou', 'Gabite', 'Gallade', 'Gallade-Mega', 'Garbodor', 'Garchomp', 'Garchomp-Mega', 'Garchomp-Mega-Z', 'Gardevoir',
  'Gardevoir-Mega', 'Garganacl', 'Gastly', 'Genesect', 'Genesect-Burn', 'Genesect-Chill', 'Genesect-Douse', 'Genesect-Shock', 'Gengar', 'Gengar-Mega',
  'Gholdengo', 'Gible', 'Gimmighoul', 'Gimmighoul-Roaming', 'Glaceon', 'Glalie', 'Glalie-Mega', 'Glimmet', 'Glimmora', 'Glimmora-Mega', 'Gogoat', 'Golbat',
  'Golett', 'Golisopod', 'Golisopod-Mega', 'Golurk', 'Golurk-Mega', 'Goodra', 'Goodra-Hisui', 'Goomy', 'Gourgeist', 'Gourgeist-Large', 'Gourgeist-Small',
  'Gourgeist-Super', 'Grafaiai', 'Grapploct', 'Greavard', 'Greninja', 'Greninja-Bond', 'Greninja-Mega', 'Groudon', 'Groudon-Primal', 'Grovyle', 'Grumpig',
  'Gulpin', 'Gyarados', 'Gyarados-Mega', 'Haunter', 'Hawlucha', 'Hawlucha-Mega', 'Heatran', 'Heatran-Mega', 'Heliolisk', 'Helioptile', 'Heracross',
  'Heracross-Mega', 'Hippopotas', 'Hippowdon', 'Honedge', 'Hoopa', 'Hoopa-Unbound', 'Houndoom', 'Houndoom-Mega', 'Houndour', 'Houndstone', 'Igglybuff',
  'Indeedee', 'Indeedee-F', 'Inkay', 'Ivysaur', 'Jigglypuff', 'Jolteon', 'Kadabra', 'Kakuna', 'Kangaskhan', 'Kangaskhan-Mega', 'Kecleon', 'Keldeo',
  'Keldeo-Resolute', 'Kirlia', 'Kleavor', 'Klefki', 'Krokorok', 'Krookodile', 'Kyogre', 'Kyogre-Primal', 'Lairon', 'Lampent', 'Larvitar', 'Latias',
  'Latias-Mega', 'Latios', 'Latios-Mega', 'Leafeon', 'Liepard', 'Litleo', 'Litwick', 'Lopunny', 'Lopunny-Mega', 'Lucario', 'Lucario-Mega', 'Lucario-Mega-Z',
  'Mabosstiff', 'Machamp', 'Machoke', 'Machop', 'Magearna', 'Magearna-Mega', 'Magearna-Original', 'Magearna-Original-Mega', 'Magikarp', 'Malamar',
  ...
  'Medicham', 'Medicham-Mega', 'Meditite', 'Meganium', 'Meganium-Mega', 'Melmetal', 'Meloetta', 'Meloetta-Pirouette', 'Meltan', 'Meowstic', 'Meowstic-F',
  'Meowstic-F-Mega', 'Meowstic-M-Mega', 'Meowth', 'Meowth-Alola', 'Meowth-Galar', 'Metagross', 'Metagross-Mega', 'Metang', 'Mewtwo', 'Mewtwo-Mega-X',
  'Mewtwo-Mega-Y', 'Milotic', 'Mime Jr.', 'Mimikyu', 'Mimikyu-Busted', 'Morpeko', 'Morpeko-Hangry', 'Mr. Mime', 'Mr. Mime-Galar', 'Mr. Rime', 'Mudkip',
  'Munna', 'Musharna', 'Nacli', 'Naclstack', 'Nickit', 'Noibat', 'Noivern', 'Numel', 'Onix', 'Overqwil', 'Palossand', 'Pancham', 'Pangoro', 'Panpour',
  'Pansage', 'Pansear', 'Patrat', 'Perrserker', 'Persian', 'Persian-Alola', 'Phantump', 'Pichu', 'Pidgeot', 'Pidgeot-Mega', 'Pidgeotto', 'Pidgey', 'Pignite',
  'Pikachu', 'Pinsir', 'Pinsir-Mega', 'Porygon', 'Porygon-Z', 'Porygon2', 'Primeape', 'Pumpkaboo', 'Pumpkaboo-Large', 'Pumpkaboo-Small', 'Pumpkaboo-Super',
  'Pupitar', 'Purrloin', 'Pyroar', 'Pyroar-Mega', 'Quilladin', 'Qwilfish', 'Qwilfish-Hisui', 'Raichu', 'Raichu-Alola', 'Raichu-Mega-X', 'Raichu-Mega-Y',
  'Ralts', 'Rayquaza', 'Rayquaza-Mega', 'Riolu', 'Rookidee', 'Roselia', 'Roserade', 'Rotom', 'Rotom-Fan', 'Rotom-Frost', 'Rotom-Heat', 'Rotom-Mow',
  'Rotom-Wash', 'Runerigus', 'Sableye', 'Sableye-Mega', 'Salamence', 'Salamence-Mega', 'Sandile', 'Sandygast', 'Sawk', 'Scatterbug', 'Sceptile',
  'Sceptile-Mega', 'Scizor', 'Scizor-Mega', 'Scolipede', 'Scolipede-Mega', 'Scovillain', 'Scovillain-Mega', 'Scrafty', 'Scrafty-Mega', 'Scraggy',
  'Scyther', 'Seviper', 'Sharpedo', 'Sharpedo-Mega', 'Shelgon', 'Shroodle', 'Shuppet', 'Simipour', 'Simisage', 'Simisear', 'Sirfetch\u2019d', 'Skarmory',
  'Skarmory-Mega', 'Skiddo', 'Skrelp', 'Sliggoo', 'Sliggoo-Hisui', 'Slowbro', 'Slowbro-Galar', 'Slowbro-Mega', 'Slowking', 'Slowking-Galar', 'Slowpoke',
  'Slowpoke-Galar', 'Slurpuff', 'Snorunt', 'Snover', 'Spewpa', 'Spinarak', 'Spoink', 'Spritzee', 'Squawkabilly', 'Squawkabilly-Blue', 'Squawkabilly-White',
  'Squawkabilly-Yellow', 'Squirtle', 'Staraptor', 'Staraptor-Mega', 'Staravia', 'Starly', 'Starmie', 'Starmie-Mega', 'Staryu', 'Steelix', 'Steelix-Mega',
  'Stunfisk', 'Stunfisk-Galar', 'Swablu', 'Swalot', 'Swampert', 'Swampert-Mega', 'Swirlix', 'Sylveon', 'Talonflame', 'Tatsugiri', 'Tatsugiri-Curly-Mega',
  'Tepig', 'Terrakion', 'Thievul', 'Throh', 'Tinkatink', 'Tinkaton', 'Tinkatuff', 'Torchic', 'Totodile', 'Toxel', 'Toxtricity', 'Toxtricity-Low-Key',
  'Treecko', 'Trevenant', 'Trubbish', 'Tynamo', 'Tyranitar', 'Tyranitar-Mega', 'Tyrantrum', 'Tyrunt', 'Umbreon', 'Vanillish', 'Vanillite', 'Vanilluxe',
  'Vaporeon', 'Venipede', 'Venusaur', 'Venusaur-Mega', 'Victreebel', 'Victreebel-Mega', 'Virizion', 'Vivillon', 'Volcanion', 'Wartortle', 'Watchog', 'Weedle',
  'Weepinbell', 'Whirlipede', 'Wigglytuff', 'Wimpod', 'Xerneas', 'Yamask', 'Yamask-Galar', 'Yveltal', 'Zangoose', 'Zeraora', 'Zeraora-Mega', 'Zubat', 'Zygarde',
  'Zygarde-10%', 'Zygarde-Complete', 'Zygarde-Mega', 'Ange',
];
