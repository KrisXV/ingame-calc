...
const ZA_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Growth': {type: 'Grass'},
  'Petal Dance': {bp: 40, multihit: [1, 3]},
  'Fire Spin': {bp: 20},
  'Fissure': {bp: 250},
  'Quick Attack': {bp: 30},
  'Skull Bash': {bp: 150, secondaries: true},
  'Bonemerang': {bp: 55, multihit: [1, 2]},
  ...
  'Icicle Spear': {multihit: [1, 5]},
  'Rock Blast': {bp: 15, multihit: [1, 5]},
  'Bullet Punch': {bp: 30},
  'Magnet Bomb': {bp: 95},
  'Seed Bomb': {bp: 35, multihit: [1, 5]},
  'Aqua Jet': {bp: 30},
...
const ZA1: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Vine Whip (B)': {...SV['Vine Whip'], bp: 30, multihit: [1, 10]},
  'Headbutt (B)': {...SV['Headbutt'], bp: 35, multihit: [1, 10]},
  'Take Down (B)': {...SV['Take Down'], bp: 100, multihit: [1, 10]},
  'Poison Sting (B)': {...SV['Poison Sting'], bp: 5, category: 'Special', multihit: [1, 10]},
  'Pin Missile (B)': {...SV['Pin Missile'], bp: 10, multihit: [1, 10]},
  'Flamethrower (B)': {...SV['Flamethrower'], bp: 4, multihit: [1, 10]},
  'Hydro Pump (B)': {...SV['Hydro Pump'], bp: 60, multihit: [1, 10]},
  'Blizzard (B)': {...SV['Blizzard'], bp: 30, multihit: [1, 10]},
  'Psybeam (B)': {...SV['Psybeam'], bp: 30, multihit: [1, 10]},
  'Hyper Beam (B)': {...SV['Hyper Beam'], bp: 75, multihit: [1, 10]},
  'Mega Drain (B)': {...SV['Mega Drain'], bp: 75},
  'Solar Beam (B)': {...SV['Solar Beam'], bp: 30, multihit: [1, 10]},
  'Thunder Shock (B)': {...SV['Thunder Shock'], bp: 20, multihit: [1, 10]},
  'Thunderbolt (B)': {...SV['Thunderbolt'], bp: 45, multihit: [1, 10]},
  'Thunder (B)': {...SV['Thunder'], bp: 40, multihit: [1, 10]},
  'Earthquake (B)': {...SV['Earthquake'], bp: 25, multihit: [1, 10]},
  'Quick Attack (B)': {...SV['Blizzard'], bp: 40},
  'Waterfall (B)': {...SV['Waterfall'], bp: 40, multihit: [1, 10]},
  'Rock Slide (B)': {...SV['Rock Slide'], bp: 45, multihit: [1, 10]},
  'Slash (B)': {...SV['Slash'], bp: 30, multihit: [1, 10]},
  'Sludge Bomb (B)': {...SV['Sludge Bomb'], bp: 40, multihit: [1, 10]},
  'Icy Wind (B)': {...SV['Icy Wind'], bp: 30, multihit: [1, 10]},
  'Outrage (B)': {...SV['Outrage'], bp: 17, multihit: [1, 10]},
  'Giga Drain (B)': {...SV['Giga Drain'], bp: 20, multihit: [1, 10]},
  'Twister (B)': {...SV['Twister'], bp: 45, multihit: [1, 10]},
  'Crunch (B)': {...SV['Crunch'], bp: 45, multihit: [1, 10]},
  'Extreme Speed (B)': {...SV['Extreme Speed'], bp: 50, multihit: [1, 10]},
  'Shadow Ball (B)': {...SV['Shadow Ball'], bp: 35, multihit: [1, 10]},
  'Rock Smash (B)': {...SV['Rock Smash'], bp: 90},
  'Whirlpool (B)': {...SV['Whirlpool'], bp: 40, multihit: [1, 10]},
  'Brick Break (B)': {...SV['Brick Break'], bp: 40, multihit: [1, 10]},
  'Hyper Voice (B)': {...SV['Hyper Voice'], bp: 40, multihit: [1, 10]},
  'Sand Tomb (B)': {...SV['Sand Tomb'], bp: 10, multihit: [1, 10]},
  'Bullet Seed (B)': {...SV['Bullet Seed'], bp: 7, multihit: [1, 10]},
  'Aerial Ace (B)': {...SV['Aerial Ace'], bp: 40, multihit: [1, 10]},
  'Water Pulse (B)': {...SV['Water Pulse'], bp: 7, multihit: [1, 10]},
  'Close Combat (B)': {...SV['Close Combat'], bp: 10, multihit: [1, 10]},
  'Poison Jab (B)': {...SV['Poison Jab'], bp: 40, multihit: [1, 10]},
  'Dark Pulse (B)': {...SV['Dark Pulse'], bp: 10, multihit: [1, 10]},
  'Air Slash (B)': {...SV['Air Slash'], bp: 25, multihit: [1, 10]},
  'Dragon Pulse (B)': {...SV['Dragon Pulse'], bp: 7, multihit: [1, 10]},
  'Dragon Rush (B)': {...SV['Dragon Rush'], bp: 50, multihit: [1, 10]},
  'Brave Bird (B)': {...SV['Brave Bird'], bp: 60, multihit: [1, 10]},
  'Earth Power (B)': {...SV['Earth Power'], bp: 30, multihit: [1, 10]},
  'Giga Impact (B)': {...SV['Giga Impact'], bp: 80, multihit: [1, 10]},
  'Shadow Claw (B)': {...SV['Shadow Claw'], bp: 40, multihit: [1, 10]},
  'Shadow Sneak (B)': {...SV['Shadow Sneak'], bp: 30, multihit: [1, 10]},
  'Zen Headbutt (B)': {...SV['Zen Headbutt'], bp: 45, multihit: [1, 10]},
  'Discharge (B)': {...SV['Discharge'], bp: 10, multihit: [1, 10]},
  'Lava Plume (B)': {...SV['Lava Plume'], bp: 60, multihit: [1, 10]},
  'Power Whip (B)': {...SV['Power Whip'], bp: 35, multihit: [1, 10]},
  'Iron Head (B)': {...SV['Iron Head'], bp: 30, multihit: [1, 10]},
  'Stone Edge (B)': {...SV['Stone Edge'], bp: 25, multihit: [1, 10]},
  'Aqua Jet (B)': {...SV['Aqua Jet'], bp: 45, multihit: [1, 10]},
  'Sludge Wave (B)': {...SV['Sludge Wave'], bp: 10, multihit: [1, 10]},
  'Hurricane (B)': {...SV['Hurricane'], bp: 40, multihit: [1, 10]},
  'Icicle Crash (B)': {...SV['Icicle Crash'], bp: 40, multihit: [1, 10]},
  'Flying Press (B)': {...SV['Flying Press'], bp: 75, multihit: [1, 10]},
  'Phantom Force (B)': {...SV['Phantom Force'], bp: 30, multihit: [1, 10]},
  'Play Rough (B)': {...SV['Play Rough'], bp: 30, multihit: [1, 10]},
  'Moonblast (B)': {...SV['Moonblast'], bp: 40, multihit: [1, 10]},
  'Dazzling Gleam (B)': {...SV['Dazzling Gleam'], bp: 25, multihit: [1, 10]},
  'Power-Up Punch (B)': {...SV['Power-Up Punch'], bp: 30, multihit: [1, 10]},
  'Thousand Arrows (B)': {...SV['Thousand Arrows'], bp: 50, multihit: [1, 10]},
  'Thousand Waves (B)': {...SV['Thousand Waves'], bp: 50, multihit: [1, 10]},
  'Land\'s Wrath (B)': {...SV['Land\'s Wrath'], bp: 60, multihit: [1, 10]},
  'Lunge (B)': {...SV['Lunge'], bp: 40, multihit: [1, 10]},
  'Core Enforcer (B)': {...SV['Core Enforcer'], bp: 200, multihit: [1, 10]},
